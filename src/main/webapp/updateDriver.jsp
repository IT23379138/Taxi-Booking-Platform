...
<head>
  ...
  <style>
    ...
    .form-info {
      background-color: var(--welcome-bg); /* Uses welcome-bg for info box */
...
<div class="container">
  ...
  <div class="form-container">
    <div class="form-info">
      Enter the Driver ID to update, then modify the fields below. All fields are required.
    </div>

    <form action="UpdateDriverServlet" method="post">
      <div class="driver-id-section">
        <div class="form-group">
          <div class="label-with-info">
            <label for="id">Driver ID to Update</label>
            <span class="label-info">(This field is case-sensitive)</span>
          </div>
      ...
      <div class="form-row">
        ...
        <div class="form-col">
          <div class="form-group">
            <label for="licenseNumber">New License Number</label>
